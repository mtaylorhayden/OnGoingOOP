...
namespace ZooConsole
{
    ...
    internal static class ConsoleHelper
    {
        ...
        /// <summary>
        /// Attaches the delegate to the zoo.
        /// </summary>
        /// <param name="zoo"> The zoo being passed in.</param>
        public static void AttachDelegates(Zoo zoo)
        {
            // Plug in the HandleBirthingRoomTemperatureChange into the delegate.
            zoo.onBirthingRoomTemperatureChange = HandleBirthingRoomTemperatureChange;
        }

        /// <summary>
        /// Changes the birthing rooms temperature.
        /// </summary>
        /// <param name="previousTemp"> The temperature that it used to be.</param>
        ...
        {
            // Write out the temperature to the console.
        ...
        public static Zoo LoadFile(string fileName)
        {
            try
            {
                // Uses the zoo's load from file method.
                Zoo zoo = Zoo.LoadFromFile(fileName);

                // Present message of validation.
        ...
        /// Save's the zoo.
        /// </summary>
        /// <param name="zoo"> The zoo being saved.</param>
        /// <param name="fileName"> The file the zoo will be saved in.</param>
        public static void SaveFile(Zoo zoo, string fileName)
        {
            try
            {
                // The zoo will save the file.
                zoo.SaveToFile(fileName);

                // Display message validating the save.
                Console.WriteLine("Your zoo has been successfully saved.");
            }
            catch
            {
                // Display message presenting that the zoo was not saved.
                Console.WriteLine("Your zoo was not successfully saved.");
            }
        }
        ...
        public static void SetTemperature(Zoo zoo, string temperature)
        {
            try
            {
                ...
                if (zoo.BirthingRoomTemperature <= BirthingRoom.MaxTemperature && zoo.BirthingRoomTemperature >= BirthingRoom.MinTemperature)
                {
                    ...
                    double changedTemp = double.Parse(temperature);

                    zoo.BirthingRoomTemperature = changedTemp;
                }
                else
                {
                    // Warning message.
