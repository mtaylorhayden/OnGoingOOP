...
namespace ZooConsole
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            // Creates a exit variable of type bool and sets it to false.
            bool exit = false;

            // Creates a command variable of type string.
            string command;
            ...
            while (!exit)
            {
                ...
                switch (commandWords[0])
                {
                    ...
                    // If you typed load.
                    case "load":
                        ConsoleHelper.LoadFile("test.zoo");
                    ...
                    case "save":
                        ...
                        ConsoleHelper.SaveFile(zoo, "test.zoo");
