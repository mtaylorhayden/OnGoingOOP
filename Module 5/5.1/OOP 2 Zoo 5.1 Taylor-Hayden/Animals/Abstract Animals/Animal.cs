...
namespace Animals
{
    ...
    public abstract class Animal : IEater, IMover, IReproducer, ICageable
    {
        ...
        /// <summary>
        /// The list of the animals childern.
        /// </summary>
        private List<Animal> childern;
        ...
        /// <summary>
        /// Notifies subscribers when the animals get changed.
        /// </summary>
        [NonSerialized]
        ...
        /// <summary>
        /// Gets or sets the birth behavior for the aniaml.
        /// </summary>
        public IBirthBehavior BirthBehavior { get; set; }

        /// <summary>
        /// Gets the collection of childern animals.
        /// </summary>
        public IEnumerable<Animal> Childern
        {
            get
            {
        ...
        /// <summary>
        /// Gets or sets the move behavior for the aniaml.
        /// </summary>
        ...
        /// </summary>
        public IEatBehavior EaterBehavior { get; set; }
        ...
        /// <summary>
        /// Gets or sets the onTextChange field.
        /// </summary>
        ...
        /// <summary>
        /// Adds the animal child.
        /// </summary>
        /// <param name="animal"></param>
        public void AddChild(Animal animal)
        {
            // Add the child to the list of childern.
            this.childern.Add(animal);
        }

        /// <summary>
        /// Creates the timers for the animals.
        /// </summary>
        ...
        public void Move()
        {
            // Call the animal's move behavior method and give it the current instance of the animal.
        ...
        {
            // Create a baby reproducer. Passed in gender as a new parameter.
            Animal baby = Activator.CreateInstance(this.GetType(), string.Empty, 0, this.Weight * (this.BabyWeightPercentage / 100), Gender.Male) as Animal;

            // Randomly sets the gender.
            Gender gender = gender = random.Next(0, 2) == 0 ? Gender.Male : Gender.Female;

            // Add the baby to the mothers list of childern
            this.AddChild(baby);
        ...
        {
            string aName = this.name + ": " + this.GetType().Name + " (" + this.Age + ", " + this.Weight + ")";

            // If the animal is pregnant add three astricks.
            aName += this.IsPregnant == true ? "***" : "";
