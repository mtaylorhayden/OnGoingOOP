...
// May need to add property to wallet?
namespace People
{
    /// <summary>
    ...
    public class Guest : IEater, ICageable
    {
        ...
        public Guest(string name, int age, decimal moneyBalance, WalletColor Color, Gender gender, IMoneyCollector checkingAccount)
        {
            ...
            // Plug the handleBalanceChange into the checkingAccount.OnBalanceChange
        ...
        public Animal AdoptedAnimal
        {
            get
            {
                return this.adpotedAnimal;
            }
            set
            {
                this.adpotedAnimal = value;
        ...
        /// <summary>
        /// Gets the weight gain percentage for the guest.
        /// </summary>
        ...
        /// <summary>
        /// Handles when the money balance is changed.
        /// </summary>
        private void HandleBalanceChange()
        {
            if (this.onTextChange != null)
            {
                // Changes the guests account balance.
                this.onTextChange(this);
            }
        }
